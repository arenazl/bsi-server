...
class DatabaseHelper {
  ...
  public async getConnection(): Promise<PoolConnection> {
    try {
      ...
      console.error("Error obtaining database connection:", err instanceof Error ? err.message : err);
      throw err;
    }
  }
...
public async executeSpJsonReturn(
  ...
  public formatDateFromFile(fechaPagoRaw: string) {
  ...
  private getfileType(tipoModulo: TipoModulo): string 
  {
