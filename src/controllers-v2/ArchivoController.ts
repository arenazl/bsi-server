...
import NominaService from '../services-v2/NominaService';
import PagoService from '../services-v2/PagoService';
    ...
    upload(req, res, async () => {
      try {
        ...
        switch (TIPO_MODULO) {
          ...
          default:
            throw new Error(`Tipo de módulo no soportado: ${TIPO_MODULO}`);
        }
